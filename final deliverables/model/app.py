...
model = load_model("C:/Users/PRIYANKA/Desktop/New folder/Updated-Xception-diabetic-retinopathy.h5")
app = Flask(__name__)
app.secret_key="abc"
app.config['UPLOAD_FOLDER'] = "User_Images"
# Authenticate using an IAM API key
client = Cloudant.iam('a/7cc87f59811447d19dfa4632c8d519bf','43ba7d39-9b65-43b1-aa19-c132d335fe78::', connect=True)
